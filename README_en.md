...
The central files in this repository are:
...
- Improving the quality of AI‑assisted dialogue  
- Providing a stable foundation for future AI interactions  
- Organizing technical and philosophical values  
- Serving as a personal archive to revisit and enjoy  
...
- Dialogue philosophy  
- Technical mindset (WSL / zsh / vim / readability‑first)  
- Core values (honesty, dignity, structure)  
- Sensitivity to story, ethics, and philosophy  
...
- Interacting with English‑based AI systems  
- Explaining values to international developers  
- Cross‑language self‑introduction  
